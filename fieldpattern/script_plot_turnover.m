...
%%
 %figure
 mysubplot(6,2, [1 3 5], '', 0.8, 0.3)
texts.ylabel ={'Patch Occupancy'};
myplot_bar([occA' occL'], style, texts)
text(-0.3, 1.1, 'a', 'FontSize',18, 'FontWeight', 'bold')
axis([0 3 0 1])
%%
% figure
