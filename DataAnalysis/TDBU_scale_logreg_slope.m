...
function out = TDBU_scale_logreg_slope(data_A, data_L, Day)
...
%%
BU=zeros(1,4);
[temp, m, b] = regression(MA_A_1(:)', DF_L_1(:)');        BU(1,1) = m;
[temp, m, b] = regression(MA_A_3(:)', DF_L_3(:)');       BU(1,2) = m;
[temp, m, b] = regression(MA_A_9(:)', DF_L_9(:)');       BU(1,3)=m;
[temp, m, b] = regression(MA_A_27(:)', DF_L_27(:)');   BU(1,4)=m;

TD=zeros(1,4);
[temp, m, b] = regression(MA_L_1(:)', DF_A_1(:)' );         TD(1,1) = m;
[temp, m, b] = regression(MA_L_3(:)', DF_A_3(:)');         TD(1,2) = m;
[temp, m, b] = regression(MA_L_9(:)', DF_A_9(:)');         TD(1,3) = m;
[temp, m, b] = regression(MA_L_27(:)', DF_A_27(:)');     TD(1,4) = m;
out= [TD;BU];
